...
* **[VSparkline](/components/sparklines/)** — interactive markers and hover tooltips (v4.1)
...
**[VSparkline](/components/sparklines/)** — gained `interactive` prop to show vertical guideline and hover tooltips ([#22748](https://github.com/vuetifyjs/vuetify/pull/22748)).
...
<!-- TODO: example for date picker (gif) -->
